...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <div class="hero-buttons">
                        @auth
                            <a href="{{ route('ideas.create') }}" class="btn btn-primary btn-lg">Submit Your Idea</a>
                            <a href="{{ route('schemes.create') }}" class="btn btn-outline-light btn-lg">Post a Scheme</a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-primary btn-lg">Submit Your Idea</a>
                            <a href="{{ route('login') }}" class="btn btn-outline-light btn-lg">Post a Scheme</a>
                            <p class="mt-3 text-white">Please login to submit ideas or post schemes</p>
                        @endauth
                    </div>
                </div>
                <div class="col-md-6 text-center">
                    <img src="{{ asset('images/hero-illustration.svg') }}" alt="Collaboration Illustration" class="hero-image img-fluid" style="max-height: 400px; width: auto;" onerror="this.src='{{ asset('images/default-hero.svg') }}'">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="cta-section">
        <div class="container text-center position-relative" style="z-index: 2;">
            ...
            <a href="{{ route('register') }}" class="btn btn-light btn-lg cta-button">Get Started</a>
        </div>
    </div>
