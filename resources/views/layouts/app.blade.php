        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    @guest
                        <li class="nav-item">
                            <a class="nav-link nav-auth-link" href="{{ route('login') }}">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-auth-link" href="{{ route('register') }}">Register</a>
                        </li>
                    @else
                        <li class="nav-item">
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('ideas.create') }}">
                                <i class="fas fa-lightbulb me-1"></i>Submit Idea
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('schemes.create') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="{{ route('ideas.create') }}">Submit Idea</a></li>
                        <li><a href="{{ route('schemes.create') }}">Post Scheme</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Contact Us</h5>
