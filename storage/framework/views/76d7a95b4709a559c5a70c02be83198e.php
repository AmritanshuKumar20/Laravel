        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="scheme-card">
                    ...
                    <form action="<?php echo e(route('schemes.store')); ?>" method="POST" enctype="multipart/form-data" id="schemeForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  placeholder="Describe the scheme in detail..." required><?php echo e(old('description')); ?></textarea>
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control <?php $__errorArgs = ['funding'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                               ...
                                               value="<?php echo e(old('funding')); ?>" required>
                                    </div>
                                    <div class="invalid-feedback">
                                        <?php $__errorArgs = ['funding'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control <?php $__errorArgs = ['contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ronik\OneDrive\Desktop\Laravel-main\resources\views/schemes/create.blade.php ENDPATH**/ ?>